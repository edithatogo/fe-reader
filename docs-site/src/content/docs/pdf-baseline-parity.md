...
Fe Reader tracks post-launch PDF baseline parity through the `advanced_pdf_baseline` feature gate. This work does not block desktop stable launch.
...
Current post-launch limitation categories include production renderer parity, editable annotation preservation, XFA and JavaScript forms, external converter fidelity, signed documents, attachments/portfolios, and OCR/searchable-PDF workflows.
