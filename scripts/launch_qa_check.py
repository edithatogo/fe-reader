...
COMMANDS: list[list[str]] = [
    ...
    ["python3", "scripts/windows_linux_beta_installers_check.py"],
    ["python3", "scripts/exhaustive_pdf_parity_taxonomy_check.py"],
    ["python3", "scripts/corpus_oracle_evidence_factory_check.py"],
    ["python3", "scripts/reader_render_search_accessibility_parity_check.py"],
    ...
    ["python3", "scripts/marketing_claim_governance_check.py"],
    ["python3", "scripts/stable_release_cutover_registries_check.py"],
...
EVIDENCE_CHECKS = {
    ...
    "windows_linux_beta_installers_contract": "docs/windows-linux-beta-installers-contract.md",
    ...
    "marketing_claim_governance_contract": "docs/marketing-claim-governance-contract.md",
    "stable_release_cutover_registries_contract": "docs/stable-release-cutover-registries-contract.md",
    "v2_roadmap_implementation_foundation_contract": "docs/v2-roadmap-implementation-foundation-contract.md",
